INSIGHTs PROaCTIVE Prototype

What this is
-----------
This mini prototype generates mock PROaCTIVE data (4 criteria) and produces a
...
Faculty (faculty-facing) plots:
 - network_simu_x_socratic.png                 <- correlation network between PROaCTIVE elements and Socratic metrics
...
CSV Structure (PROaCTIVE mock):

student_id	attempt	[12 element columns]

The 16 element columns represent the four PROaCTIVE Socratic Dialogue criteria:
  PRO_01: Question Formulation (4 elements)
  PRO_02: Response Quality (4 elements)
  PRO_03: Critical Thinking (4 elements)
  PRO_04: Assumption Recognition (4 elements)
